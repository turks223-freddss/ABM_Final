...
def run_single_simulation(
    ...
    shopper_mix: dict[str, float] | None = None,
    shopping_list_size: int | None = None,
    patience_threshold: float = 0.40,
    ...
    if days > 1:
        return run_multi_day_simulation(
            ...
            shopper_mix=shopper_mix,
            shopping_list_size=shopping_list_size,
            patience_threshold=patience_threshold,
            sale_item_count=sale_item_count,
            sale_discount_min=sale_discount_min,
            sale_discount_max=sale_discount_max,
...
def run_multi_day_simulation(
    ...
    seed: int | None,
    promotion_level: float,
    shopper_mix: dict[str, float] | None,
    shopping_list_size: int | None,
    patience_threshold: float,
    sale_item_count: int | None,
    sale_discount_min: float,
    sale_discount_max: float,
    num_cashiers: int,
    output_dir: str | Path,
    make_plots: bool,
    days: int,
